...
public class RoundedDrawable extends Drawable {
   ...
   * @return the {@link RoundedDrawable} for chaining.
   */
  public RoundedDrawable setCornerRadius(@paosp.about.Corner int corner, float radius) {
  ...
  public RoundedDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
    ...
    mCornersRounded[paosp.about.Corner.TOP_LEFT] = topLeft > 0;
    mCornersRounded[paosp.about.Corner.TOP_RIGHT] = topRight > 0;
    mCornersRounded[paosp.about.Corner.BOTTOM_RIGHT] = bottomRight > 0;
    mCornersRounded[paosp.about.Corner.BOTTOM_LEFT] = bottomLeft > 0;
    return this;
  }
