...
public class RoundedImageView extends ImageView {
  ...
  private ColorStateList mBorderColor =
      ColorStateList.valueOf(paosp.about.RoundedDrawable.DEFAULT_BORDER_COLOR);
  ...
  public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (mBorderColor == null) {
      mBorderColor = ColorStateList.valueOf(paosp.about.RoundedDrawable.DEFAULT_BORDER_COLOR);
    }
  ...
  public void setImageDrawable(Drawable drawable) {
    mResource = 0;
    mDrawable = paosp.about.RoundedDrawable.fromDrawable(drawable);
    updateDrawableAttrs();
  ...
  public void setImageBitmap(Bitmap bm) {
    mResource = 0;
    mDrawable = paosp.about.RoundedDrawable.fromBitmap(bm);
    updateDrawableAttrs();
    super.setImageDrawable(mDrawable);
  }
  ...
  private Drawable resolveResource() {
    ...
    return paosp.about.RoundedDrawable.fromDrawable(d);
  }
  ...
  private void updateBackgroundDrawableAttrs(boolean convert) {
    if (mMutateBackground) {
      if (convert) {
        mBackgroundDrawable = paosp.about.RoundedDrawable.fromDrawable(mBackgroundDrawable);
      }
  ...
  private void updateAttrs(Drawable drawable) {
    ...
    if (drawable instanceof paosp.about.RoundedDrawable) {
      ((paosp.about.RoundedDrawable) drawable)
      ...
      if (mCornerRadii != null) {
        ((paosp.about.RoundedDrawable) drawable).setCornerRadius(
            mCornerRadii[paosp.about.Corner.TOP_LEFT],
            mCornerRadii[paosp.about.Corner.TOP_RIGHT],
            mCornerRadii[paosp.about.Corner.BOTTOM_RIGHT],
            mCornerRadii[paosp.about.Corner.BOTTOM_LEFT]);
   ...
   * @return the radius.
   */
  public float getCornerRadius(@paosp.about.Corner int corner) {
   ...
   */
  public void setCornerRadiusDimen(@paosp.about.Corner int corner, @DimenRes int resId) {
   ...
   */
  public void setCornerRadius(@paosp.about.Corner int corner, float radius) {
  ...
  public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
    if (mCornerRadii[paosp.about.Corner.TOP_LEFT] == topLeft
        && mCornerRadii[paosp.about.Corner.TOP_RIGHT] == topRight
        && mCornerRadii[paosp.about.Corner.BOTTOM_RIGHT] == bottomRight
        && mCornerRadii[paosp.about.Corner.BOTTOM_LEFT] == bottomLeft) {
      return;
    }

    mCornerRadii[paosp.about.Corner.TOP_LEFT] = topLeft;
    mCornerRadii[paosp.about.Corner.TOP_RIGHT] = topRight;
    mCornerRadii[paosp.about.Corner.BOTTOM_LEFT] = bottomLeft;
    mCornerRadii[paosp.about.Corner.BOTTOM_RIGHT] = bottomRight;
  ...
  public void setBorderColor(ColorStateList colors) {
    ...
    mBorderColor =
        (colors != null) ? colors : ColorStateList.valueOf(paosp.about.RoundedDrawable.DEFAULT_BORDER_COLOR);
    updateDrawableAttrs();
    updateBackgroundDrawableAttrs(false);
    if (mBorderWidth > 0) {
      invalidate();
